<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Hotel.aspx.cs" Inherits="ECCVWebsite.Hotel" %>
				...
				<div class="infopanel padded">
					...
					<form name="changedates" id="changedates" method="get" action="" style="display:none;">
						<fieldset class="box">
							...
							<p class="fl">
								<label class="" for="number_change" style="margin-bottom:7px;">Persons</label><br/>
